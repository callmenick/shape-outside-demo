(function(){
  ...
  gitFork.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=shape-outside-demo&type=fork&count=true');
  ...
  gitWatch.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=shape-outside-demo&type=watch&count=true');
